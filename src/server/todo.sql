...
--
-- Name: users; Type: TABLE; Schema: public; Owner: wxs
--
...
ALTER TABLE public.users OWNER TO wxs;

--
-- Name: users_uid_seq; Type: SEQUENCE; Schema: public; Owner: wxs
--
...
ALTER TABLE public.users_uid_seq OWNER TO wxs;

--
-- Name: users_uid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: wxs
--
...
--
-- Name: users uid; Type: DEFAULT; Schema: public; Owner: wxs
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: wxs
--
